...
```{r,fig.height=5, fig.width=6, , fig.align='center'}
# Family-level:
plotRawFossilOccs(mammals_fossil, tax_lvl = "family", knitr = TRUE)

# Genus level:
plotRawFossilOccs(mammals_fossil, tax_lvl = "genus", knitr = TRUE)

# Species level:
plotRawFossilOccs(mammals_fossil, tax_lvl = "species", knitr = TRUE)
```
