...
Because we know whale originated ~36 million years ago, we can simulate many alternative diversification scenarios, following the parameters we eestimated:
...
So the empirical phylogeny is very different fomr the simulated. What hypotheses can students make to explain this discrepancy?
