...
Bug & issue reports, suggestions, improvements, or code additions should be pushed through the same GitHub repository. Emailing Matheus Januario is also ok. Additional info on how to contribute can be found [here](https://github.com/mjanuario/evolved/blob/main/CONTRIBUTING.md).
