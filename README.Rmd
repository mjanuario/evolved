...
This educational R package involves both simple and complex functions for simulating and analyzgin biological data. It is adequate for inquiries that assume different levels of student independence (e.g., as categorized by Banchi & Bell, 2008), and add up to other options of software where students can handle, organize, and visualize biological data. 
